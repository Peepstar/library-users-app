...
public class LibraryUserDTO implements UserDTO{
    ...
    // Check if userRole is valid before deserialization to throw personalized exception.
    public void setUserRole(String role) throws WrongRoleException {
        try {
            this.userRole = Role.valueOf(role);
        } catch (IllegalArgumentException e) {
            throw new WrongRoleException("Invalid value for userRole. Only LIBRARIAN and MEMBER are allowed");
        }
    }
